...
interface ScottProps {
  title?: string;
}

export default function Scott({ title }: ScottProps) {
  ...
  return (
    <section id="bobby" className="w-full bg-fadedpurple py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            <span className="bg-lightblue px-4 py-1 w-64 inline-block">
              GROUP COO
            </span>
          </motion.h5>
          ...
          >
            ...
            <div className="md:hidden">
              <MobileReadMore limit={200}>
                We bring together specialist services, from supported living and
                residential care to community, mental health, and children’s
                services, all united by one purpose: to move care forward. Our
                teams are guided by compassion, professionalism, and respect.
                Every day, we work alongside individuals, families, and local
                authorities to deliver meaningful, person-centred care that
                helps people live with confidence, dignity, and independence.
              </MobileReadMore>
            </div>
          </motion.div>
        </motion.div>
